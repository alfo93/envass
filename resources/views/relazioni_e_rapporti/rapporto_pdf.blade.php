...
<body>
    <script type="text/php">
        if ( isset($pdf) ) {
            $pdf->page_text(507, 760, "Pag. {PAGE_NUM} di {PAGE_COUNT}", 'calibri', 6, array(0, 0, 0));
        }
    </script>
    <header id="header">
    ...
    <footer>
        ...
        <div>
            ...
            <span style="font-size:8px">Il presente Rapporto è generato elettronicamente solo dopo la validazione dei risultati da parte del Laboratorio.
            Gli originali firmati sono conservati presso il laboratorio. Ogni prelievo è completo di foto delle piastre consultabili su richiesta del committente.
            I Risultati contenuti nel presente rapporto si riferiscono esclusivamente al/i campione/i provato/i. Il presente rapporto non può essere riprodotto parzialmente,
            salvo approvazione scritta del laboratorio. <br>(¹) L'incertezza di misura è calcolata in accordo alla norma ISO 19036 moltiplicando lo scarto tipo di riproducibilità intralaboratorio
            per un fattore di copertura k = 2, che dà un livello di fiducia del 95%.<br>NA = Non Applicato, NR/R = Non rilevato/Rilevato</span>
        </div>
        <br>
            ...
            <tbody>
                <tr>
                    <td style="text-align: left; font-size: 9px;">
                        MOD 01 PR_G_03 RDP REV. 0_30-06-2022
                    </td>
    ...
    <main style="margin-top: 3cm;">
            ...
            <table style="margin-top: 0cm; padding-top: 0cm; border-collapse: separate; border-spacing:0.5cm;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $struttura_partizione }}</b><br>
                            <b>{{ $indirizzo_struttura }}</td>
                        <br><br>
                    </tr>
                    <tr>
                        <td><i>Verbale di campionamento</i></td>
                        <td>
        ...
        <div class="page break" id="page2">           
            <table class="tabellaGridPage2" style="width: 100%;">
                <thead>
                    <tr>
                        <th colspan="2" class="tabellaGridPage2" style="text-align: left; background-color: grey;">PIANO DI CAMPIONAMENTO ARIA</th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="tabellaGridPage2 col1">
                        <td class="tabellaGridPage2"><b>Dispositivo di campionamento</b></td>
                        <td class="tabellaGridPage2">
                            {{ $dispositivo_di_campionamento_1 }}
                        </td>
                    </tr>
                    <tr class="tabellaGridPage2">
                        <td class="tabellaGridPage2 col1"><b>Tipo di campionamento</b></td>
                        <td class="tabellaGridPage2">
                            Statico
                        </td>
                    </tr>
                    <tr class="tabellaGridPage2">
                        <td class="tabellaGridPage2 col1"><b>Portata</b></td>
                        <td class="tabellaGridPage2">
                            {{ $portata }}
                        </td>
                    </tr>
                    <tr class="tabellaGridPage2">
                        <td class="tabellaGridPage2 col1"><b>Volume campionato</b></td>
                        <td class="tabellaGridPage2">
                            {{ $volume_campionato }}
                        </td>
                    </tr>
            ...
            <table class="tabellaGridPage2" style="width: 100%;">
                <thead>
                    <tr class="tabellaGridPage2" style="background-color: grey;">
                        <th class="tabellaGridPage2 col1" style="text-align: left;">Monitoraggio di</th>
                        <th class="tabellaGridPage2">Microrganismi totali a 30°C</th>
                        <th class="tabellaGridPage2">Lieviti e muffe</th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="tabellaGridPage2">
                        <td class="tabellaGridPage2 col1"><b>Tipo di substrato per la crescita</b></td>
                        <td class="tabellaGridPage2" style="text-align:center;">
                    ...
                    <tr class="tabellaGridPage2">
                        <td class="tabellaGridPage2 col1"><b>Condizioni e durata dell'incubazione</b></td>
                        <td class="tabellaGridPage2" style="text-align:center;">
                    ...
                    <tr class="tabellaGridPage2">
                        <td class="tabellaGridPage2 col1"><b>Descrizione e punto di campionamento</b></td>
                        <td class="tabellaGridPage2" style="text-align:center;">
                    ...
                    <tr class="tabellaGridPage2">
                        <td class="tabellaGridPage2 col1"><b>Numero prelievi per punto</b></td>
                        <td class="tabellaGridPage2" style="text-align:center;">
                    ...
                    <tr class="tabellaGridPage2">
                        <td class="tabellaGridPage2 col1"><b>Note</b></td>
                        <td class="tabellaGridPage2" style="text-align:center;">
            ...
            <table class="tabellaGridPage2" style="width:100%;">
                <thead>
                    <tr>
                        <th colspan="2" class="tabellaGridPage2" style="text-align: left; background-color: grey;">PIANO DI CAMPIONAMENTO SUPERFICI</th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="tabellaGridPage2">
                        <td class="tabellaGridPage2 col1"><b>Dispositivo di campionamento</b></td>
                        <td class="tabellaGridPage2">
                            {{ $dispositivo_di_campionamento_2 != '' ? $dispositivo_di_campionamento_2 : '/'}}
                        </td>
                    </tr>
                    <tr class="tabellaGridPage2">
                        <td class="tabellaGridPage2 col1"><b>Area di campionamento</b></td>
                        <td class="tabellaGridPage2">
            ...
            <table class="tabellaGridPage2" style="width: 100%;">
                <thead>
                    <tr class="tabellaGridPage2" style="background-color: grey;">
                        <th class="tabellaGridPage2 col1" style="text-align: left;"><b>Monitoraggio di</b></th>
                        <th class="tabellaGridPage2"><b>Microrganismi totali a 30°C</b></th>
                        <th class="tabellaGridPage2"><b>Lieviti e muffe</b></th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="tabellaGridPage2">
        ...
        <!-- pagina 3 -->
        <div class="page break" id="page3">            
            <table class="tabellaGridPage3-4" style="width: 100%;">
                <thead>
                    <tr class="tabellaGridPage3-4">
                        <th class="tabellaGridPage3-4" colspan="6" style="background-color: rgb(189, 183, 183); text-align:left;">NOTE DI CAMPIONAMENTO<br>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="tabellaGridPage3-4 col1_page3"><b>Data di campionamento ora inizio e fine</b></td>
                        @php $counter = 1; @endphp
                        @foreach($data_di_campionamento_ora_inizio_e_fine_aria_at_rest as $doif)
                        @if($counter <= 5)
                            <td class="tabellaGridPage3-4 coln_page3">
                                {{ $doif ?? '/' }}
                            </td>
                    ...
                    <tr>
                        <td class="tabellaGridPage3-4 col1_page3"><b>STRUM. n°</b></td>
                        @php $counter = 1; @endphp
                        @foreach($strum_n_aria_at_rest as $s)
                        @if($counter <= 5)
                            <td class="tabellaGridPage3-4 coln_page3">
                                {{ $s ?? '/' }}
                            </td>
                    ...
                    <tr>
                        <td class="tabellaGridPage3-4 col1_page3"><b>Data di campionamento ora inizio e fine</b></td>
                        @php $counter = 1; @endphp
                        @foreach($data_di_campionamento_ora_inizio_e_fine_aria_operat as $doif)
                        @if($counter <= 5)
                            <td class="tabellaGridPage3-4 coln_page3">
                                {{ $doif ?? '/' }}
                            </td>
                    ...
                    <tr>
                        <td class="tabellaGridPage3-4 col1_page3"><b>STRUM. n°</b></td>
                        @php $counter = 1; @endphp
                        @foreach($strum_n_aria_operat as $s)
                        @if($counter <= 5)
                            <td class="tabellaGridPage3-4 coln_page3">
                                    {{ $s ?? '/' }}
                                </td>
                    ...
                    <tr>
                        <td class="tabellaGridPage3-4 col1_page3"><b>Tipo di operazione</b></td>
                        @php $counter = 1; @endphp
                        @foreach($tipo_di_operazione as $to)
                        @if($counter <= 5)
                            <td class="tabellaGridPage3-4 coln_page3">
                                {{ $to ?? '/' }}
                            </td>
            ...
            <table class="tabellaGridPage3-4" style="width: 100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="tabellaGridPage3-4 col1_page3"><b>Data di campionamento ora inizio e fine</b></td>
                        @php $counter = 1; @endphp
                        @foreach($data_di_campionamento_ora_inizio_e_fine_superfici as $dcs)
                        @if($counter <= 5)
                            <td class="tabellaGridPage3-4 coln_page3">
                                {{ $dcs ?? '/' }}
                            </td>
        ...
        @if($numero_colonne > 5)
        <!-- pagina 4 -->
        <div class="page break" id="page4">            
            <table class="tabellaGrid" style="width: 100%;">
                <thead>
                    <tr class="tabellaGrid">
                        <th class="tabellaGrid" colspan="6" style="background-color: rgb(189, 183, 183); text-align:left;">NOTE DI CAMPIONAMENTO<br>
                            Descrizione del luogo di campionamento incluse le eventuali attività generanti aerosol
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td class="tabellaGrid col1_page3"><b>Tipo di ambiente</b></td>
                        @php $counter = 6 @endphp
                        @foreach($tipo_di_ambiente as $t)
                        @if($counter <= $numero_colonne)
                            <td class="tabellaGrid coln_page3">
                                    {{ $t ?? '/' }}
                            </td>
                            @php $counter++ @endphp
                        @endif
                    ...
                    <tr>
                        <td class="tabellaGrid col1_page3"><b>Numero e codifica locali</b></td>
                        @php $counter = 6 @endphp
                        @foreach($numero_e_codifica_locali as $ncl)
                        @if($counter <= $numero_colonne)
                            <td class="tabellaGrid coln_page3">
                    ...
                    <tr>
                        <td class="tabellaGrid col1_page3"><b>Classe ISO di Riferimento</b></td>
                        @php $counter = 6 @endphp
                        @foreach($class_iso_di_riferimento as $cir)
                        @if($counter <= $numero_colonne)
                            <td class="tabellaGrid coln_page3">
                    ...
                    <tr>
                        <td class="tabellaGrid col1_page3"><b>Tipo di flusso</b></td>
                        @php $counter = 6 @endphp
                        @foreach($tipo_di_flusso as $tf)
                        @if($counter <= $numero_colonne)
                            <td class="tabellaGrid coln_page3">
                    ...
                    <tr>
                        <td class="tabellaGrid col1_page3"><b>Note</b></td>
                        @php $counter = 6 @endphp
                        @foreach($note_pagina3 as $n)
                        @if($counter <= $numero_colonne)
                            <td class="tabellaGrid coln_page3">
                ...
                <tbody>
                    <tr>
                        <td class="tabellaGrid col1_page3"><b>Stato di occupazione</b></td>
                        @php $counter = 6 @endphp
                        @foreach($stato_di_occupazione_aria_at_rest as $s)
                        @if($counter <= $numero_colonne)
                            <td class="tabellaGrid coln_page3">
                    ...
                    <tr>
                        <td class="tabellaGrid col1_page3"><b>Data di campionamento ora inizio e fine</b></td>
                        @php $counter = 6 @endphp
                        @foreach($data_di_campionamento_ora_inizio_e_fine_aria_at_rest as $doif)
                        @if($counter <= $numero_colonne)
                            <td class="tabellaGrid coln_page3">
                    ...
                    <tr>
                        <td class="tabellaGrid col1_page3"><b>STRUM. n°</b></td>
                        @php $counter = 6 @endphp
                        @foreach($strum_n_aria_at_rest as $s)
                        @if($counter <= $numero_colonne)
                            <td class="tabellaGrid coln_page3">
                    ...
                    <tr>
                        <td class="tabellaGrid col1_page3"><b>N. Persone presenti</b></td>
                        @php $counter = 6 @endphp
                        @foreach($n_persone_presenti_aria_at_rest as $np)
                        @if($counter <= $numero_colonne)
                            <td class="tabellaGrid coln_page3">
                    ...
                    <tr>
                        <td class="tabellaGrid col1_page3"><b>Stato porte</b></td>
                        @php $counter = 6 @endphp
                        @foreach($stato_porte_aria_at_rest as $sp)
                        @if($counter <= $numero_colonne)
                            <td class="tabellaGrid coln_page3">
                    ...
                    <tr>
                        <td class="tabellaGrid col1_page3"><b>Campionamento effettuato da</b></td>
                        @php $counter = 6 @endphp
                        @foreach($campionamento_effettuato_da_aria_at_rest as $ced)
                        @if($counter <= $numero_colonne)
                            <td class="tabellaGrid coln_page3">
                    ...
                    <tr>
                        <td class="tabellaGrid col1_page3"><b>Tipo di operazione</b></td>
                        @php $counter = 6 @endphp
                        @foreach($tipo_di_operazione as $to)
                        @if($counter <= $numero_colonne)
                            <td class="tabellaGrid coln_page3">
        ...
        <!-- pagina 6 -->
        <div class="page break" id="page6">            
            <table class="tabellaGridPage6" style="width: 100%;">
                <thead>
                    <tr>
                        <th class="tabellaGridPage6" colspan="2" style="background-color: rgb(189, 183, 183); text-align:left;">
                            <b>ANAGRAFICA CAMPIONAMENTO</b>
                        </th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="tabellaGridPage6">
                        <td class="col1_page6 tabellaGridPage6">
                            <b>Incaricati del campionamento</b>
                        </td>
                        <td class="coln_page6 tabellaGridPage6">
                            {{ $incaricati_del_campionamento }}
                        </td>
                    </tr>
                    <tr>
                        <td class="col1_page6 tabellaGridPage6">
                            <b>Data campionamento</b>
                        </td>
                        <td class="coln_page6 tabellaGridPage6">
                            {{ $data_campionamento }}
                        </td>
                    ...
                    <tr>
                        <td class="col1_page6 tabellaGridPage6">
                            <b>Inizio campionamento</b>
                        </td>
                        <td class="coln_page6 tabellaGridPage6">
                            Partenza dal laboratorio/accensione data logger (STRUM_{{ $inizio_campionamento_strum }})/(15&#xf7;25)°C: {{ $dataOraPartenza }}
                        </td>
                    </tr>
                    <tr>
                        <td class="col1_page6 tabellaGridPage6">
                            <b>Inizio attività in loco</b>
                        </td>
                        <td class="coln_page6 tabellaGridPage6">
                            Inizio campionamento in loco/spegnimento data logger (STRUM_{{ $inizio_attivita_in_loco_strum }}) / (2&#xf7;8)°C: {{ $dataOraInizio }}
                        </td>
                    </tr>
                    <tr>
                        <td class="col1_page6 tabellaGridPage6">
                            <b>Fine attività in loco</b>
                        </td>
                        <td class="coln_page6 tabellaGridPage6">
                            Fine campionamento in loco/spegnimento data logger (STRUM_{{ $fine_attivita_in_loco_strum }}) / (15&#xf7;25)°C: {{ $dataOraFine }}
                        </td>
                    </tr>
                    <tr>
                        <td class="col1_page6 tabellaGridPage6">
                            <b>Fine campionamento</b>
                        </td>
                        <td class="coln_page6 tabellaGridPage6">
                            Arrivo al laboratorio/spegnimento data logger (STRUM_{{ $fine_campionamento_strum }}) / (2&#xf7;8)°C: {{ $dataOraArrivo }}
                        </td>
                    </tr>
                    <tr>
                        <td class="col1_page6 tabellaGridPage6">
                        ...
                        <td class="coln_page6 tabellaGridPage6">
                            {{ Carbon\Carbon::parse($data_accettazione)->format('d/m/Y') }}
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            @foreach($riferimenti as $key => $riferimento)
                @foreach($riferimento as $numero => $inserito)
                    ...
                    @elseif($numero == 5 && $inserito == 1)
                        ...
                        <h4>Riferimento {{ $riferimento_inserito }}</h4>
                        Contaminazione microbiologica dell’aria in condizioni Operational (capitolo 3.3.2 – ISPESL 2009):
                        la contaminazione biologica nell’aria ambiente, in prossimità del tavolo operatorio, per sala operatoria convenzionale in attività, non deve superare o essere uguale al valore di 20 UFC/m&#179; con impianto VCCC a flusso unidirezionale.
                        </p>
                    </div>
                    @php $num_riferimenti_inseriti++; @endphp
                ...
                {{-- <tbody id="sign">
                    <tr>
                        <td style="text-align: center">
                            <br/><br/>
                            @if($rapprel->firmaDirettore)
                                <img style="margin-top: 1cm; text-align: center; margin-left: 0px; padding-left: 0px;"  class="firmaDirettore" src="{{ Storage::disk('public')->path("/firme/firma_mazzacane.png") }}">
                            @else
                                <hr style="margin-top: 1cm; text-align: center">
                            @endif
                        </td>
                        <td style="text-align: center">
                            <br/><br/>
                            @if($rapprel->firmaResponsabile)
                                <img style="margin-top: 1cm; text-align: center; margin-left: 0px; padding-left: 0px;" class="firmaResponsabile" src="{{Storage::disk('public')->path("/firme/firma_caselli.png") }}">
                            @else
                                <hr style="margin-top: 1cm; text-align: center">
                            @endif
                        </td>
