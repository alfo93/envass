                ...
                <tr>
                    ...
                    <td>
                        <div class="row clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 ml-1">
                                <div class="form-group">
                                    <input type="text" name="num_rdp" class="form-control" value="{{ isset($rdp_anteprima->n_rdp) && $anteprima == 1 ? $rdp_anteprima->n_rdp : ''}} " style="padding-left: 5px;">
                                </div>
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <b><input type="text" name="struttura_sede" class="form-control hidden" value="{{ $struttura->sede . " - " . $struttura->provincia }}" readonly></b>
                            <b><input type="text" name="indirizzo_struttura" class="form-control" style="width: 50%; padding-left: 5px;" value=" {{ (isset($rdp_anteprima->indirizzo_struttura) && $anteprima == 1) ? $rdp_anteprima->indirizzo_struttura : '' }} "></b>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td><b>Verbale di campionamento</b></td>
                    <td>
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <input type="text" id="verbale_campionamento" value="{{ (isset($rdp_anteprima->verbale_campionamento) && $anteprima == 1) ? $rdp_anteprima->verbale_campionamento : '' }}" name="verbale_campionamento" style="padding-left: 10px;" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                    </td>
