...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card card-collapsable">
            ...
            <form action="{{ URL::action('RapportoRelazioneController@createDocumento') }}" method="get">
            <div class="body body-collapsable demo-masked-input">
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <select class="form-control show-tick" id="societa_campagna" name="id_societa">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <select class="form-control show-tick" id="progetti_campagna" name="id_progetto">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <select class="form-control show-tick" id="struttura_campagna" name="id_struttura">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <select class="form-control show-tick" id="partizione_campagna" name="id_reparto">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input type="date" class="form-control" id="data_campagna" name="data_campagna" value="{{ old('data_campagna') ?? ''}}">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row clearfix" style="text-align: end">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <button type="submit" class="btn btn-primary waves-effect" id="genera_rapporto">Crea Rapporto</button>
                    </div>
                </div>
            </div>
            </form>
