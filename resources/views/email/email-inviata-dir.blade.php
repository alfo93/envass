                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Gentilissimi,<br>
                                        Con la seguente mail viene inviata la richiesta di approvazione per il rapporto di prova {{ $nome }} inerente ai campionamenti effettuati per la campagna aperta in data {{ $data_campagna }}, presso la struttura {{ $struttura }} nella partizione {{ $area_partizione != null ? $reparto. " " .$area_partizione : $reparto }}.
