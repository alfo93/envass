...
<head>
    ...
    <title>Documentazione pronta | {{ config('app.name')  }}</title>
    <style type="text/css">
                        ...
                        <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 24px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        </p>
                                    <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        Gentilissimo  {{ $tecnico }},<br>
                                        Con la seguente mail ti comunichiamo che il rapporto di prova {{ $nome }} inerente ai campionamenti effettuati per la campagna aperta in data {{ $data_campagna }}, presso la struttura {{ $struttura }} nella partizione {{ $area_partizione != null ? $reparto. " " .$area_partizione : $reparto }}
                                        @if($motivo != null || $motivo != '')
                                            non è stato approvato con la seguente motivazione: <br> {{ $motivo }}
                                        @else
                                            è stato approvato.
                                        @endif
                                        <br><br>Cordiali saluti,<br>
                                        {{ auth()->user()->nome . " " . auth()->user()->cognome }}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ Carbon\Carbon::now()->format('d/m/Y') }}
                                        <br>

                                        <br><br><br><br>
                                        <small>Questa e-mail è generata automaticamente da un indirizzo di posta elettronica di solo invio; si chiede pertanto di non rispondere al messaggio</small>
                                    </p>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td class="content-cell" align="center"
                                    ...
                                    <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; line-height: 1.5em; margin-top: 0; color: #aeaeae; font-size: 12px; text-align: center;">
                                        Università degli Studi di Ferrara</p>
                                </td>
                            </tr>
                        </table>
                    </td>
