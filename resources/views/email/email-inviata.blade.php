                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <p style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                        ...
                                        con la presente e-mail si informa che è stato emesso dal Laboratorio CIAS il rapporto di prova ({{ $nome }}), relativo al campionamento svolto presso il {{ $area_partizione != null ? $reparto. " " .$area_partizione : $reparto }} della struttura {{ $struttura }} in data {{ $data_campagna }}. Il documento è consultabile e scaricabile all'interno della sua area personale.<br>
                                        Cordiali Saluti.
                                        <br>
